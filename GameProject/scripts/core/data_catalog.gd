...
const TUTORIAL_ENCOUNTERS := [
	{"id": "tutorial_01", "type": "normal", "name": "训练腐鼠", "units": [{"name": "训练腐鼠", "rank": "normal", "hp": 12, "attack": 3, "defense": 0, "traits": []}]},
	{"id": "tutorial_02", "type": "normal", "name": "迟缓守卫", "units": [{"name": "迟缓守卫", "rank": "normal", "hp": 18, "attack": 4, "defense": 2, "traits": []}]},
	{"id": "tutorial_03", "type": "normal", "name": "投石哥布林", "units": [{"name": "投石哥布林", "rank": "normal", "hp": 16, "attack": 4, "defense": 1, "traits": []}]},
