...
| 套装 ID | 套装 | 装备名 | 栏位 | 基础属性 |
| --- | --- | --- | --- | --- |
| sparta | 斯巴达 | 大马士革钢刀 | 武器 | 生命 +0；攻击 +5；护甲 +0。 |
| sparta | 斯巴达 | 斯巴达盾 | 副手 | 生命 +2；攻击 +0；护甲 +2。 |
| sparta | 斯巴达 | 斯巴达胸甲 | 上身 | 生命 +8；攻击 +0；护甲 +1。 |
| sparta | 斯巴达 | 斯巴达头盔 | 头部 | 生命 +5；攻击 +0；护甲 +1。 |
| sparta | 斯巴达 | 斯巴达护胫 | 护腿 | 生命 +5；攻击 +0；护甲 +1。 |
| sparta | 斯巴达 | 斯巴达鞋 | 脚部 | 生命 +3；攻击 +0；护甲 +0。 |
| boxer | 拳击手 | 冠军腰带 | 腰部 | 生命 +4；攻击 +2；护甲 +0。 |
| boxer | 拳击手 | 拳击裤 | 下身 | 生命 +5；攻击 +1；护甲 +1。 |
| boxer | 拳击手 | 拳击手套 | 手部 | 生命 +2；攻击 +3；护甲 +0。 |
| circus | 马戏团 | 鞭子 | 武器 | 生命 +0；攻击 +4；护甲 +0。 |
| circus | 马戏团 | 火把 | 副手 | 生命 +3；攻击 +1；护甲 +0。 |
| circus | 马戏团 | 小丑面具 | 头部 | 生命 +4；攻击 +0；护甲 +1。 |
| circus | 马戏团 | 杂技手套 | 手部 | 生命 +2；攻击 +2；护甲 +0。 |
| jungle | 丛林 | 丛林弓 | 武器 | 生命 +0；攻击 +5；护甲 +0。 |
| jungle | 丛林 | 剥皮刀 | 副手 | 生命 +2；攻击 +2；护甲 +0。 |
| jungle | 丛林 | 草帽 | 头部 | 生命 +4；攻击 +0；护甲 +1。 |
| jungle | 丛林 | 树叶衣 | 上身 | 生命 +5；攻击 +0；护甲 +1。 |
| jungle | 丛林 | 树叶裤 | 下身 | 生命 +5；攻击 +0；护甲 +1。 |
| jungle | 丛林 | 编制手套 | 手部 | 生命 +2；攻击 +2；护甲 +0。 |
